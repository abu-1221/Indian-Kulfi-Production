...
# CORS Configuration
CORS_ALLOWED_ORIGINS = _as_list(os.getenv('CORS_ALLOWED_ORIGINS'), default='')
CORS_ALLOW_ALL_ORIGINS = _as_bool(os.getenv('CORS_ALLOW_ALL_ORIGINS'), default=DEBUG)

# Add Railway domain to CORS if present
if railway_origin and railway_origin not in CORS_ALLOWED_ORIGINS:
